...
class BackupService
{
    ...
    public function backup()
    {
         ...
         * File generation
         */
        $filename = DIRECTORY_SEPARATOR . now() . "-testmate-backup.testmate";
        $path = "public" . DIRECTORY_SEPARATOR . "backup" . $filename;
        DB::table("testmate_backups")->insert([
            "filename" => $filename,
            ...
            "bak_type" => TestMateBackup::TYPE_BACKUP,
        ]);
        Storage::put($path, $textInBackup);
    }

    /**
     * Restore testmate-cbt data
     *
     * @since 3.16.0
     */
    public function restore($backupLiteral, $originalName)
    {
        $data_detail = [
            ...
            "bak_type" => TestMateBackup::TYPE_RESTORE,
        ];
        ...
        try {
            ...
            DB::table("testmate_backups")->insert($data_detail);
        }
    }
    ...
    {
        return [
            "code" => config("testmate.version.code"),
