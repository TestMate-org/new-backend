        ...
        <div class="py-2 px-2 my-2 border-b border-gray-200">
          ...
          class="py-1 px-1 flex space-x-1 bg-gray-100 border border-gray-200 rounded-md mb-4">
            ...
            <div class="text-gray-600 flex-1">
              Anda telah menyelesaikan test ini, prestasi penting tetapi jujur yang utama. <br>kembali ke halaman utama bila masih ada test selanjutnya.
				    </div>
			    </div>
			    <div class="">
				    <button
            ...
            class="py-2 px-4 text-center text-white rounded-md hover:shadow-lg bgdark">{{ isLoading ? 'Loading...' : 'Ke halaman utama' }}</button>
			    </div>
