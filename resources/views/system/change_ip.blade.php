...
@section("content")
<form class="max-w-sm mx-auto" method="post" action="{{ route('system.testmate.change.ip.store') }}">
  @csrf
  <div class="mb-2">
  ...
  <div class="mt-2 flex space-x-2">
    <a href="{{ route('system.testmate.index') }}" class="text-center border-gray-800 border-2 text-gray-800 block w-full py-2 rounded-md">Kembali</a>
