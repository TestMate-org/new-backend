...
@section("content")
  ...
  <div class="flex items-center justify-center space-x-4">
    <div class="grid grid-cols-2 gap-4">
      <a href="{{ route('system.testmate.change.ip') }}" class="shadow-sm bg-white border-2 border-gray-300 text-gray-900 px-14 py-6 rounded-md text-sm font-medium text-center bg-gray-50">
        <span class="text-gray-600 font-semibold">Ganti IP</span>
      </a>
      <a href="{{ route('system.testmate.check.update') }}" class="shadow-sm bg-white border-2 border-gray-300 text-gray-900 px-14 py-6 rounded-md text-sm font-medium text-center bg-gray-50">
